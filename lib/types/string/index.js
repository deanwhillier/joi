    ...
    rules: {
        ...
        base64: {
            method: function (options = {}) {
                ...
                options = Object.assign({urlSafe: false, paddingRequired: true}, options);
        ...
        dataUri: {
            method: function (options = {}) {
                ...
                options = Object.assign({paddingRequired: true}, options);
                Hoek.assert(typeof options.paddingRequired === 'boolean', 'paddingRequired must be boolean');
        ...
        hex: {
            method: function (options = {}) {
                ...
                options = Object.assign({ byteAligned: false }, options);
